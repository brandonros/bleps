...
#[allow(unused)]
pub struct Chip {
    pub arm_core_base_address: u32,
    pub socsram_base_address: u32,
    pub bluetooth_base_address: u32,
    pub socsram_wrapper_base_address: u32,
    pub sdiod_core_base_address: u32,
    pub pmu_base_address: u32,
    pub chip_ram_size: u32,
    pub atcm_ram_base_address: u32,
    pub socram_srmem_size: u32,
    pub chanspec_band_mask: u32,
    pub chanspec_band_2g: u32,
    pub chanspec_band_5g: u32,
    pub chanspec_band_shift: u32,
    pub chanspec_bw_10: u32,
    pub chanspec_bw_20: u32,
    pub chanspec_bw_40: u32,
    pub chanspec_bw_mask: u32,
    pub chanspec_bw_shift: u32,
    pub chanspec_ctl_sb_lower: u32,
    pub chanspec_ctl_sb_upper: u32,
    pub chanspec_ctl_sb_none: u32,
    pub chanspec_ctl_sb_mask: u32,
}
